// Modified Date: 2005-09-19 10:34:32
// Modified Language: 1397191522
...
//<script type='text/javascript'><!--
//	function BuildCOMViewStructure(pobjSrc) {
	function BuildCOMViewStructure() {
	 var obj,obj2,obj3,obj4,objDiv1;
	 objDiv=document.createElement('div');
	 //if (document.WWW.YBED.value != 'PHIL') {
	 WWW.insertAdjacentElement('BeforeBegin',objDiv);
	 //} else {
	 //pobjSrc.insertAdjacentElement('BeforeBegin',objDiv);
	 //}
	 objDiv.style.display='none';
	 ...
	 obj.style.height='100%';
	  ...
	  obj.className='fieldset-save';
	   cvCreateButton(obj,'new.gif','Com00185',NewView);
	   cvCreateButton(obj,'open.gif','Com00191',EditView);
	   cvCreateButton(obj,'save.gif','Com00192',SaveView);
	   cvCreateButton(obj,'del.gif','Com00193',DeleteView);
	   obj2=document.createElement('img');obj.appendChild(obj2);
	   obj2.src=FilePath+'delimiter.gif';
	   obj2=cvCreateButton(obj,'print.gif','Com00170',PrintSelection);
	   obj2.attachEvent('oncontextmenu',PrintOptions);
	   obj2=cvCreateButton(obj,'copy.gif','Com00194',CopySelection);	   
	   obj2=cvCreateButton(obj,'selectall.gif','Com00195',SelectAll);	   
	...
	function cvCreateButton(obj,src,title,event) {
