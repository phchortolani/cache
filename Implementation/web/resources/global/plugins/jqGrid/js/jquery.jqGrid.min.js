    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        ...
        return this.each(function () {
            ...
            if (!this.grid) {
                ...
                var
                    e = this, f = {
                        headers: [], cols: [], footers: [], dragStart: function (a, b, c) {
                            ...
                            if (this.resizing) {
                                var
                                    b, c, e = a.pageX - this.resizing.startX, f = this.headers[this.resizing.idx], g = "ltr" === d.direction ? f.width + e : f.width - e;
                                g > 33 && (this.curGbox.css({left: this.resizing.sOL + e}), !0 === d.forceFit ? (b = this.headers[this.resizing.idx + d.nv], (c = "ltr" === d.direction ? b.width - e : b.width + e) > d.minColWidth && (f.newWidth = g, b.newWidth = c)) : (this.newWidth = "ltr" === d.direction ? d.tblwidth + e : d.tblwidth - e, f.newWidth = g))
                            }
                        }, dragEnd: function (a) {
                            if (this.hDiv.style.cursor = "default", this.resizing) {
                                var
                                    b = this.resizing.idx, c = this.headers[b].newWidth || this.headers[b].width;
                            ...
                            if (a) {
                                ...
                                if (c) {
                                    f.prevRowHeight = c;
                                    var
                                        h, i, j, k = d.rowNum, l = f.scrollTop = f.bDiv.scrollTop, m = Math.round(g.position().top) - l, n = m + g.height(), o = c * k;
                                    if (n < a && m <= 0 && (void
                ...
                var
                    k, l = $.jgrid.getMethod("getStyleUI"), m = e.p.styleUI + ".common", n = l(m, "disabled", !0), o = l(m, "highlight", !0), p = l(m, "hover", !0), q = l(m, "cornerall", !0), r = l(m, "icon_base", !0), s = $.jgrid.styleUI[e.p.styleUI || "jQueryUI"].colmenu, t = $.jgrid.msie(), u = [], v = [], w = [];
                ...
                var
                    y, z = ["shiftKey", "altKey", "ctrlKey"], A = function (a, b) {
                        return a = parseInt(a, 10), isNaN(a) ? b || 0 : a
                    }, B = function (a, b, c, d, g, h) {
                        var
                            i, j, k = e.p.colModel[a], l = k.align, m = 'style="', n = k.classes, o = k.name, p = [];
                        ...
                        if (void
                            ...
                            var
                                i = {rowId: a, colModel: h, gid: e.p.id, pos: c, styleUI: e.p.styleUI};
                        ...
                        var
                            a, b, c, d, f, g, h, i, j, k, l, m = e.p, n = m.data, o = n.length, p = m.localReader, q = m.colModel, r = p.cell, s = (!0 === m.multiselect ? 1 : 0) + (!0 === m.subGrid ? 1 : 0) + (!0 === m.rownumbers ? 1 : 0), t = m.scroll ? $.jgrid.randId() : 1;
                        ...
                        var
                            g, h = "-1", i = "", j = b ? "display:none;" : "", k = $(e).triggerHandler("jqGridRowAttr", [d, f, a]);
                        if ("object" != typeof
                        ...
                        if (g && (e.p.data = [], e.p._index = {}, e.p.localReader.id = h), e.p.reccount = 0, $.isXMLDoc(a)) {
                            ...
                            var
                                k, n, o, p, q, r, s, t, u, v = $(e), w = 0, x = !0 === e.p.multiselect ? 1 : 0, y = 0, z = !0 === e.p.rownumbers ? 1 : 0, B = [], C = {}, D = [], K = l(m, "rowBox", !0, "jqgrow ui-row-" + e.p.direction);
                            ...
                            var
                                N, O = L.length, P = 0, Q = [], R = parseInt(e.p.rowNum, 10), S = e.p.scroll ? $.jgrid.randId() : 1, T = $(e).find("tbody:first"), U = !1;
                        ...
                        if (a) {
                            -1 !== e.p.treeANode || e.p.scroll ? b = b > 1 ? b : 1 : (J.call(e, !1, !0), b = 1);
                            var
                                g, h, i = "_id_", j = "local" !== e.p.datatype && e.p.loadonce || "jsonstring" === e.p.datatype;
                            ...
                            var
                                k, n, p, q, r, s, t, u, v, w, x, y = $(e), z = 0, B = [], C = e.p.multiselect ? 1 : 0, D = !0 === e.p.subGrid ? 1 : 0, K = !0 === e.p.rownumbers ? 1 : 0, L = I(C + D + K), N = H(h), O = {}, P = [], Q = l(m, "rowBox", !0, "jqgrow ui-row-" + e.p.direction);
                            ...
                            var
                                R, S = parseInt(e.p.rowNum, 10), T = e.p.scroll ? $.jgrid.randId() : 1, U = !1;
                            d && (S *= d + 1), "local" !== e.p.datatype || e.p.deselectAfterSort || (U = !0);
                            var
                                V, W = $.isFunction(e.p.afterInsertRow), X = [], Y = !1, Z = $(e).find("tbody:first"), _ = K ? l(m, "rownumBox", !1, "jqgrid-rownum") : "", aa = C ? l(m, "multiBox", !1, "cbox") : "";
                        ...
                        var
                            c, d, f, g, h = e.p.multiSort ? [] : "", i = [], j = !1, k = {}, l = [], m = [];
                        if ($.isArray(e.p.data)) {
                            var
                            ...
                            var
                                w = s.select(), x = parseInt(e.p.rowNum, 10), y = w.length, z = parseInt(e.p.page, 10), A = Math.ceil(y / x), B = {};
                        ...
                        var
                            c, d, f, g, h, i, j, k, o = "", q = e.p.pager ? $.jgrid.jqID(e.p.pager.substr(1)) : "", r = q ? "_" + q : "", s = e.p.toppager ? "_" + e.p.toppager.substr(1) : "";
                        if (f = parseInt(e.p.page, 10) - 1, f < 0 && (f = 0), f *= parseInt(e.p.rowNum, 10), h = f + e.p.reccount, e.p.scroll) {
                            ...
                            if (u) {
                                var
                                    v = f * u, w = parseInt(e.p.records, 10) * u;
                        ...
                        if (!e.grid.hDiv.loading) {
                            var
                                b, c, d = e.p.scroll && !1 === a, f = {}, g = e.p.prmNames;
                            ...
                            var
                                h = $.isFunction(e.p.loadComplete), i = h ? e.p.loadComplete : null, j = 0;
                        ...
                        var
                            c, d, f, g, h, j, k, o = "<td class='ui-pg-button " + n + "'><span class='ui-separator'></span></td>", q = "", s = "<table class='ui-pg-table ui-common-table ui-paging-pager'><tbody><tr>", t = "", u = function (a, b) {
                                var
                                    c;
                        ...
                        if ("rtl" === i && (s += t), !0 === e.p.pginput && (q = "<td id='input" + b + "' dir='" + i + "'>" + $.jgrid.template($.jgrid.getRegional(e, "defaults.pgtext", e.p.pgtext) || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(a) + "'></span>") + "</td>"), !0 === e.p.pgbuttons) {
                            var
                                w = ["first" + b, "prev" + b, "next" + b, "last" + b], x = l(m, "pgButtonBox", !0, "ui-pg-button"), y = [$.jgrid.getRegional(e, "defaults.pgfirst", e.p.pgfirst) || "", $.jgrid.getRegional(e, "defaults.pgprev", e.p.pgprev) || "", $.jgrid.getRegional(e, "defaults.pgnext", e.p.pgnext) || "", $.jgrid.getRegional(e, "defaults.pglast", e.p.pglast) || ""];
                        ...
                        "ltr" === i && (s += t), s += "</tr></tbody></table>", !0 === e.p.viewrecords && $("td#" + a + "_" + e.p.recordpos, "#" + c).append("<div dir='" + i + "' style='text-align:" + e.p.recordpos + "' class='ui-paging-info'></div>"), $("td#" + a + "_" + e.p.pagerpos, "#" + c).append(s), j = $("#gbox_" + $.jgrid.jqID(e.p.id)).css("font-size") || "11px", $("#gbox_" + $.jgrid.jqID(e.p.id)).append("<div id='testpg' " + l(m, "entrieBox", !1, "ui-jqgrid") + " style='font-size:" + j + ";visibility:hidden;' ></div>"), h = $(s).clone().appendTo("#testpg").width(), $("#testpg").remove(), h > 0 && ("" !== q && (h += 50), $("td#" + a + "_" + e.p.pagerpos, "#" + c).width(h)), e.p._nvtd = [], e.p._nvtd[0] = h ? Math.floor((e.p.width - h) / 2) : Math.floor(e.p.width / 3), e.p._nvtd[1] = 0, s = null, $(".ui-pg-selbox", "#" + c).on("change", function () {
                            ...
                            var
                                a = A(e.p.page, 1), c = A(e.p.lastpage, 1), d = !1, f = !0, g = !0, h = !0, i = !0;
                        ...
                        var
                            d, f = e.p.colModel, g = e.p.frozenColumns ? b : e.grid.headers[a].el, h = "";
                        ...
                        if (e.p.colModel[b].sortable && !(e.p.savedRow.length > 0)) {
                            if (c || (e.p.lastsort === b && "" !== e.p.sortname ? "asc" === e.p.sortorder ? e.p.sortorder = "desc" : "desc" === e.p.sortorder && (e.p.sortorder = "asc") : e.p.sortorder = e.p.colModel[b].firstsortorder || "asc", e.p.page = 1), e.p.multiSort) Y(b, f, d); else {
                                if (d) {
                                    if (e.p.lastsort === b && e.p.sortorder === d && !c)return;
                                    e.p.sortorder = d
                                }
                                var
                                    g, h = e.grid.headers[e.p.lastsort] ? e.grid.headers[e.p.lastsort].el : null, i = e.p.frozenColumns ? f : e.grid.headers[b].el, j = "single" === e.p.viewsortcols[1];
                        ...
                        var
                            a, b, c, d, g = 0, h = $.jgrid.cell_width ? 0 : A(e.p.cellLayout, 0), i = 0, j = A(e.p.scrollOffset, 0), k = !1, l = 0;
                        ...
                        var
                            b = $(e.grid.headers[a].el), c = [b.position().left + b.outerWidth()];
                        ...
                        var
                            b, c = e.grid.headers, d = $.jgrid.getCellIndex(a);
                        ...
                        var
                            d, f, g = e.p.colModel, h = g.length, i = [], j = $.jgrid.getRegional(e, "colmenu"), k = '<ul id="col_menu" class="ui-search-menu  ui-col-menu modal-content" role="menu" tabindex="0" style="left:' + b + "px;top:" + a + 'px;">';
                        for (d = 0; d < h; d++) {
                            var
                                l = g[d].hidden ? "" : "checked", m = g[d].name, n = e.p.colNames[d];
                        ...
                        var
                            f, g, h, i, j, k = e.p.colModel[a], l = "", m = "", n = "", o = "", q = "", r = "", t = ["eq", "ne", "lt", "le", "gt", "ge", "nu", "nn", "in", "ni"], u = ["eq", "ne", "bw", "bn", "ew", "en", "cn", "nc", "nu", "nn", "in", "ni"], v = $.jgrid.getRegional(e, "search"), w = $.jgrid.styleUI[e.p.styleUI || "jQueryUI"].common;
                        if (k) {
                        ...
                        var
                            c = e.p.colModel[a], d = e.p.groupingView;
                        ...
                        var
                            c, d = [], f = e.p.colModel.length, g = -1, h = e.p.colModel;
                        ...
                        var
                            d, f, g = $(".ui-jqgrid-view").css("font-size") || "11px", h = '<ul id="column_menu" class="ui-search-menu modal-content column-menu" role="menu" tabindex="0" style="font-size:' + g + ";left:" + b + "px;top:" + c + 'px;">', i = e.p.colModel[a], j = $.extend({
                                sorting: !0,
                                columns: !0,
                                filtering: !0,
                                seraching: !0,
                                grouping: !0,
                                freeze: !0
                            }, i.coloptions), k = $.jgrid.getRegional(e, "colmenu"), l = e.p.colNames[a];
                        ...
                        $("#column_menu > li > a").hover(function () {
                            ...
                            var
                                b = $(this).attr("value"), c = e.grid.headers[a].el;
                ...
                var
                    ja, ka, la, ma, na, oa, pa, qa, ra, sa = "<thead><tr class='ui-jqgrid-labels' role='row'>", ta = "", ua = "", va = "";
                ...
                var
                    Ba = $("tr:first", sa), Ca = "<tr class='jqgfirstrow' role='row'>";
                ...
                var
                    Da = $("<table " + l(m, "headerTable", !1, "ui-jqgrid-htable ui-common-table") + " style='width:" + e.p.tblwidth + "px' role='presentation' aria-labelledby='gbox_" + this.id + "'></table>").append(sa), Ea = !(!e.p.caption || !0 !== e.p.hiddengrid), Fa = $("<div class='ui-jqgrid-hbox" + ("rtl" === i ? "-rtl" : "") + "'></div>"), Ga = "Bootstrap" !== e.p.styleUI || isNaN(e.p.height) ? 0 : 2;
                sa = null, f.hDiv = document.createElement("div"), f.hDiv.style.width = f.width - Ga + "px", f.hDiv.className = l(m, "headerDiv", !0, "ui-jqgrid-hdiv"), $(f.hDiv).append(Fa), $(Fa).append(Da), Da = null, Ea && $(f.hDiv).hide(), e.p.pager && ("string" == typeof
                    e.p.pager ? "#" !== e.p.pager.substr(0, 1) && (e.p.pager = "#" + e.p.pager) : e.p.pager = "#" + $(e.p.pager).attr("id"), $(e.p.pager).css({width: f.width + "px"}).addClass(l(m, "pagerBox", !0, "ui-jqgrid-pager")).appendTo(x), Ea && $(e.p.pager).hide(), X(e.p.pager, "")), !1 === e.p.cellEdit && !0 === e.p.hoverrows && $(e).on({
                ...
                $(e).before(f.hDiv).on({
                    click: function (a) {
                        ...
                        var
                            c = $(na).filter(":enabled").hasClass("cbox"), d = $(e).triggerHandler("jqGridBeforeSelectRow", [oa[0].id, a]);
                        ...
                        if ("A" !== na.tagName && ("INPUT" !== na.tagName && "TEXTAREA" !== na.tagName && "OPTION" !== na.tagName && "SELECT" !== na.tagName || c))if (Ha = oa[0].id, na = $(na).closest("tr.jqgrow>td"), na.length > 0 && (Ia = $.jgrid.getCellIndex(na)), !0 !== e.p.cellEdit) {
                            if (na.length > 0 && (Ja = $(na).closest("td,th").html(), $(e).triggerHandler("jqGridCellSelect", [Ha, Ia, Ja, a]), $.isFunction(e.p.onCellSelect) && e.p.onCellSelect.call(e, Ha, Ia, Ja, a)), d)if (e.p.multimail && e.p.multiselect) {
                                if (a.shiftKey) {
                                    if (c) {
                                        var
                                            g = $(e).jqGrid("getGridParam", "selrow"), h = $(e).jqGrid("getInd", Ha), i = $(e).jqGrid("getInd", g), j = "", k = "";
                                ...
                                e.p.multikey ? a[e.p.multikey] ? $(e).jqGrid("setSelection", Ha, !0, a) : e.p.multiselect && c && (c = $("#jqg_" + $.jgrid.jqID(e.p.id) + "_" + Ha).is(":checked"), $("#jqg_" + $.jgrid.jqID(e.p.id) + "_" + Ha)[e.p.useProp ? "prop" : "attr"]("checked", !c)) : b(Ha, c, a, !0)
                        } else if (e.p.multiselect && c && d) $(e).jqGrid("setSelection", Ha, !0, a); else if (na.length > 0)try {
                ...
                var
                    Ka = r + " " + l(m, "icon_caption_open", !0), La = r + " " + l(m, "icon_caption_close", !0);
                ...
                if (e.p.toppager && (e.p.toppager = $.jgrid.jqID(e.p.id) + "_toppager", f.topDiv = $("<div id='" + e.p.toppager + "'></div>")[0], e.p.toppager = "#" + e.p.toppager, $(f.topDiv).addClass(l(m, "toppagerBox", !0, "ui-jqgrid-toppager")).width(f.width - Ga).insertBefore(f.hDiv), X(e.p.toppager, "_t")), e.p.footerrow && (f.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], Fa = $("<div class='ui-jqgrid-hbox" + ("rtl" === i ? "-rtl" : "") + "'></div>"), $(f.sDiv).append(Fa).width(f.width - Ga).insertAfter(f.hDiv), $(Fa).append(Aa), f.footers = $(".ui-jqgrid-ftable", f.sDiv)[0].rows[0].cells, e.p.rownumbers && (f.footers[0].className = l(m, "rownumBox", !0, "jqgrid-rownum")), Ea && $(f.sDiv).hide()), Fa = null, e.p.caption) {
                    ...
                    !0 === e.p.hidegrid && ($(".ui-jqgrid-titlebar-close", f.cDiv).click(function (a) {
                        var
                            b, c = $.isFunction(e.p.onHeaderClick), d = ".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-toppager, .ui-jqgrid-pager, .ui-jqgrid-sdiv", g = this;
        ...
        getGridParam: function (a, b) {
            ...
            var
                e, f, g, h, i, j, k, l, m, n, o, p, q, r = !1, s = "", t = "", u = "";
            return b && ($.isArray(b) ? (m = !0, n = a) : (b = [b], m = !1), this.each(function () {
                ...
                i = !0 === v.p.rownumbers ? 1 : 0, g = !0 === v.p.multiselect ? 1 : 0, h = !0 === v.p.subGrid ? 1 : 0, m || (void
                    0 !== a ? a = String(a) : (a = $.jgrid.randId(), !1 !== v.p.keyName && (n = v.p.keyName, void
                        0 !== b[0][n] && (a = b[0][n]))));
                var
                    x = 0, y = $(v).jqGrid("getStyleUI", v.p.styleUI + ".base", "rowBox", !0, "jqgrow ui-row-" + v.p.direction), z = {}, A = !!$.isFunction(v.p.afterInsertRow);
            ...
            return this.each(function () {
                ...
                if (d.grid) {
                    "string" == typeof
                        a && (a = [a]), b = "none" !== b ? "" : "none";
                    var
                        g = "" === b, h = d.p.groupHeader && ($.isArray(d.p.groupHeader) || $.isFunction(d.p.groupHeader));
            ...
            return a = $.extend({
                ...
                var
                    b, c, d = "show" === a.method, e = $("#load_" + $.jgrid.jqID(this.p.id)), f = $(window).scrollTop();
            ...
            return this.each(function () {
                if (this.grid) {
                    var
                        a = this, b = a.p.colModel, c = 0, d = b.length, e = -1, f = !1, g = $(a).jqGrid("getStyleUI", a.p.styleUI + ".base", "headerDiv", !0, "ui-jqgrid-hdiv"), h = $(a).jqGrid("getStyleUI", a.p.styleUI + ".common", "hover", !0), i = "border-box" === $("#gbox_" + $.jgrid.jqID(a.p.id)).css("box-sizing"), j = i ? 1 : 0;
                    if (!0 !== a.p.subGrid && !0 !== a.p.treeGrid && !0 !== a.p.cellEdit && !a.p.sortable && !a.p.scroll && !0 !== a.p.grouping) {
                        for (; c < d && !0 === b[c].frozen;)f = !0, e = c, c++;
                        if (e >= 0 && f) {
                            var
                                k = a.p.caption ? $(a.grid.cDiv).outerHeight() : 0, l = parseInt($(".ui-jqgrid-htable", "#gview_" + $.jgrid.jqID(a.p.id)).height(), 10), m = parseInt($(".ui-jqgrid-hdiv", "#gview_" + $.jgrid.jqID(a.p.id)).height(), 10);
                            ...
                            $(a).on("jqGridResizeStop.setFrozenColumns", function (b, c, d) {
                                var
                                    e = i ? "outerWidth" : "width", f = $(".ui-jqgrid-htable", a.grid.fhDiv), g = $(".ui-jqgrid-btable", a.grid.fbDiv);
            ...
            return this.each(function () {
                var
                    d, e, f = this.grid, g = this.p, h = g.colModel, i = h.length;
                if ("string" == typeof
                        a) {
    ...
    a.fmatter = {}, a.extend(a.fmatter, {
        ...
        NumberFormat: function (b, c) {
            if (a.fmatter.isNumber(b) || (b *= 1), a.fmatter.isNumber(b)) {
                var
                    d, e = b < 0, f = String(b), g = c.decimalSeparator || ".";
        ...
        if (void
            ...
            var
                h, i = !0 == (null != c.colModel.editoptions && !0 === c.colModel.editoptions.multiple), j = [];
...
!function (a) {
    ...
    a.extend(a.jgrid, {
        showModal: function (a) {
            ...
            var
                i = this, j = "rtl" === a(d.gbox).attr("dir"), k = a.jgrid.styleUI[d.styleUI || "jQueryUI"].modal, l = a.jgrid.styleUI[d.styleUI || "jQueryUI"].common, m = document.createElement("div");
            ...
            if (d.resize)if (a.fn.jqResize) a(m).append("<div class='jqResize " + k.resizable + " " + l.icon_base + " " + k.icon_resizable + "'></div>"), a("#" + a.jgrid.jqID(b.themodal)).jqResize(".jqResize", !!b.scrollelm && "#" + a.jgrid.jqID(b.scrollelm)); else
                try {
                    a(m).resizable({handles: "se, sw", alsoResize: !!b.scrollelm && "#" + a.jgrid.jqID(b.scrollelm)})
                } catch (a) {
                }
            !0 === d.closeOnEscape && a(m).keydown(function (c) {
                if (27 === c.which) {
                    var
            ...
            if (c = a.extend({
                    ...
                    c.focusField && c.focusField >= 0 ? c.focusField = parseInt(c.focusField, 10) : "boolean" != typeof
                        c.focusField || c.focusField ? c.focusField = 0 : c.focusField = !1, a.fn.jqm && !0 === c.jqm) c.jqM ? a(b).attr("aria-hidden", "false").jqm(c).jqmShow() : a(b).attr("aria-hidden", "false").jqmShow(); else if ("" !== c.gbox && (a(".jqgrid-overlay:first", c.gbox).show(), a(b).data("gbox", c.gbox)), a(b).show().attr("aria-hidden", "false"), c.focusField >= 0)try {
            ...
            switch (b) {
                ...
                case"select":
                    ...
                    if (!0 === c.multiple ? (l = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : l = !1, null != c.dataUrl) {
                        ...
                        i.p && i.p.idPrefix && (n = a.jgrid.stripPref(i.p.idPrefix, n)), a.ajax(a.extend({
                            ...
                            success: function (b) {
                                var
                                    c, d = [], e = this.elem, f = this.vl, h = a.extend({}, this.options), j = !0 === h.multiple, k = !0 === h.cacheUrlData, l = "", m = a.isFunction(h.buildSelect) ? h.buildSelect.call(i, b) : b;
                                if ("string" == typeof
                        ...
                        if ("string" == typeof
                            ...
                            if (b > 0)return a
                        }).join(w)), s = document.createElement("option"), s.setAttribute("role", "option"), s.value = r[0], s.innerHTML = r[1], h.appendChild(s), l || a.trim(r[0]) !== a.trim(d) && a.trim(r[1]) !== a.trim(d) || (s.selected = "selected"), l && (a.inArray(a.trim(r[1]), m) > -1 || a.inArray(a.trim(r[0]), m) > -1) && (s.selected = "selected"); else if ("[object Array]" === Object.prototype.toString.call(c.value))for (t = c.value, p = 0; p < t.length; p++)2 === t[p].length && (u = t[p][0], v = t[p][1], s = document.createElement("option"), s.setAttribute("role", "option"), s.value = u, s.innerHTML = v, h.appendChild(s), l || a.trim(u) !== a.trim(d) && a.trim(v) !== a.trim(d) || (s.selected = "selected"), l && (a.inArray(a.trim(v), m) > -1 || a.inArray(a.trim(u), m) > -1) && (s.selected = "selected")); else if ("object" == typeof
                                c.value) {
                            t = c.value;
                            for (u
                                in
                ...
                case"custom":
                    ...
                    try {
                        ...
                        var
                            z = a.jgrid.getRegional(i, "errors"), A = a.jgrid.getRegional(i, "edit");
                        "e1" === b ? a.jgrid.info_dialog(z.errcap, "function 'custom_element' " + A.msg.nodefined, A.bClose, {styleUI: i.p.styleUI}) : "e2" === b ? a.jgrid.info_dialog(z.errcap, "function 'custom_element' " + A.msg.novalue, A.bClose, {styleUI: i.p.styleUI}) : a.jgrid.info_dialog(z.errcap, "string" == typeof
                ...
                default:
                    var
                        B;
                    B = "button" === b ? "button" : "textbox", h = document.createElement("input"), h.type = b, h.value = d, g(h, c), "button" !== b && (e ? c.size || a(h).css({width: "96%"}) : c.size || (c.size = 20)), a(h).attr("role", B)
            }
            return h
    ...
    a.jgrid.extend({
        editGridRow: function (c, d) {
            ...
            return d = a.extend(!0, {
                ...
                f(c, d, e, f) {
                    ...
                    if ("_empty" !== c && (r = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function (n) {
                            if (h = this.name, i = (!this.editrules || !0 !== this.editrules.edithidden) && !0 === this.hidden, l = i ? "style='display:none'" : "", "cb" !== h && "subgrid" !== h && !0 === this.editable && "rn" !== h) {
                                if (!1 === r) k = ""; else if (h === d.p.ExpandColumn && !0 === d.p.treeGrid) k = a("td[role='gridcell']:eq(" + n + ")", d.rows[r]).text(); else {
                                    try {
                                ...
                                var
                                    t = a.extend({}, this.editoptions || {}, {
                                        ...
                                        rowabove: !1,
                                        rowcontent: ""
                                    }, this.formoptions || {}), w = parseInt(v.rowpos, 10) || p + 1, x = parseInt(2 * (parseInt(v.colpos, 10) || 1), 10);
                            ...
                            switch (s.p.autoencode && (g = a.jgrid.htmlDecode(g)), (!0 === b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) && (s.p.savedData[f] = g), f = a.jgrid.jqID(f), m[h].edittype) {
                                ...
                                case"custom":
                                    try {
                                        ...
                                        "e1" === c ? a.jgrid.info_dialog(G.errcap, "function 'custom_value' " + b[a(this)[0]].p.msg.nodefined, a.rp_ge[a(this)[0]].p.bClose, {styleUI: b[a(this)[0]].p.styleUI}) : a.jgrid.info_dialog(G.errcap, c.message, a.rp_ge[a(this)[0]].p.bClose, {styleUI: b[a(this)[0]].p.styleUI})
                                    }
                            }
                            l++
                        }
                ...
                k() {
                    var
                        c, e, f, g, k, l, m, n = [!0, "", ""], o = {}, p = s.p.prmNames, q = a(s).triggerHandler("jqGridAddEditBeforeCheckValues", [u, a(y), w]);
                    q && "object" == typeof
                        q && (u = q), a.isFunction(b[s.p.id].beforeCheckValues) && (q = b[s.p.id].beforeCheckValues.call(s, u, a(y), w)) && "object" == typeof
                        q && (u = q);
                    for (g
                        in
                        u)if (u.hasOwnProperty(g) && (n = a.jgrid.checkValues.call(s, u[g], g), !1 === n[0]))break;
                            ...
                            v = a.extend({
                                ...
                                complete: function (g, j) {
                                    ...
                                    if (a("#sData", A + "_2").removeClass(h.active), u[e] = s.p.idPrefix + u[e], g.status >= 300 && 304 !== g.status ? (n[0] = !1, n[1] = a(s).triggerHandler("jqGridAddEditErrorTextFormat", [g, w]), a.isFunction(b[s.p.id].errorTextFormat) ? n[1] = b[s.p.id].errorTextFormat.call(s, g, w) : n[1] = j + " Status: '" + g.statusText + "'. Error code: " + g.status) : (n = a(s).triggerHandler("jqGridAddEditAfterSubmit", [g, u, w]), void
                                                0 === n && (n = [!0, "", ""]), n[0] && a.isFunction(b[s.p.id].afterSubmit) && (n = b[s.p.id].afterSubmit.call(s, g, u, w))), !1 === n[0]) a(".FormError", y).html(n[1]), a(".FormError", y).show(); else if (s.p.autoencode && a.each(u, function (b, c) {
                ...
                l(b, c) {
                    var
                        d, e = !1;
                    if (!(e = !(a.isPlainObject(b) && a.isPlainObject(c) && Object.getOwnPropertyNames(b).length === Object.getOwnPropertyNames(c).length)))for (d
                        in
            ...
            return d = a.extend(!0, {
                ...
                k() {
                    var
                        b = a(l).jqGrid("getDataIDs"), c = a("#id_g", "#" + o).val();
                ...
                if (l.grid && c) {
                    ...
                    if (a(l.p.colModel).each(function () {
                        ...
                        f(c, l, y, t);
                        var
                            z = "rtl" === l.p.direction, A = z ? "nData" : "pData", B = z ? "pData" : "nData", C = "<a id='" + A + "' class='fm-button " + h.button + "'><span class='" + h.icon_base + " " + g.icon_prev + "'></span></a>", D = "<a id='" + B + "' class='fm-button " + h.button + "'><span class='" + h.icon_base + " " + g.icon_next + "'></span></a>", E = "<a id='cData' class='fm-button " + h.button + "'>" + d.bClose + "</a>";
                        if (u > 0) {
                            var
                                F = [];
            ...
            return d = a.extend(!0, {
                ...
                if (e.grid && c) {
                    var
                        f, i, j, k, l = e.p.id, m = {}, n = !0, o = "DelTbl_" + a.jgrid.jqID(l), p = "DelTbl_" + l, q = {
                            themodal: "delmod" + l,
                            modalhead: "delhd" + l,
                    ...
                    if (b[e.p.id].styleUI = e.p.styleUI || "jQueryUI", a.isArray(c) && (c = c.join()), void
                        ...
                        var
                            r = isNaN(b[e.p.id].dataheight) ? b[e.p.id].dataheight : b[e.p.id].dataheight + "px", s = isNaN(d.datawidth) ? d.datawidth : d.datawidth + "px", t = "<div id='" + p + "' class='formdata' style='width:" + s + ";overflow:auto;position:relative;height:" + r + ";'>";
                        ...
                        var
                            u = "<a id='dData' class='fm-button " + h.button + "'>" + d.bSubmit + "</a>", v = "<a id='eData' class='fm-button " + h.button + "'>" + d.bCancel + "</a>";
            ...
            if (!this.filter) {
                ...
                if (this.p.initFilter = a.extend(!0, {}, this.p.filter), d) {
                    ...
                    this.onchange = function () {
                        ...
                        var
                            c, d, f, g = "", h = "", i = ["int", "integer", "float", "number", "currency"];
        ...
        filterRefactor: function (b) {
            ...
            try {
                if (h = "string" == typeof
                    ...
                    f[a] && g.rules.push({data: f[a], op: e.op, field: e.field})
                }), c.splice(d, 1), d--))
            } catch (a) {
            }
            return h
                        ...
                        e, f, g, h = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].filter, i = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].common, j = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].base, k = function () {
                            ...
                            if (!0 === b.stringResult || "local" === d.p.datatype || !0 === b.searchOperators) {
                                ...
                                if (k && a.jgrid.filterRefactor({
                                    ...
                                    var
                                        b = 0 === a ? "ge" : "le";
                                    (t = v[a]) && w.rules.push({data: v[a], op: b, field: u.field})
                                }), r.splice(s, 1), s--));
                            ...
                            var
                                x;
                            b.url && (x = d.p.url, a(d).jqGrid("setGridParam", {url: b.url}));
                            var
                            ...
                            var
                                k;
                            b.url && (k = d.p.url, a(d).jqGrid("setGridParam", {url: b.url}));
                            var
                ...
                if (d.grid) {
                    var
                        e, f = "fbox_" + d.p.id, g = !0, h = !0, i = {
                            ...
                            scrollelm: f
                        }, j = a.isPlainObject(d.p_savedFilter) && !a.isEmptyObject(d.p_savedFilter) ? d.p_savedFilter : d.p.postData[b.sFilter], k = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].filter, l = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].common;
                    if (b.styleUI = d.p.styleUI, "string" == typeof
                        ...
                        var
                            p, q, r = a.extend([], d.p.colModel), s = "<a id='" + f + "_search' class='fm-button " + l.button + " fm-button-icon-right ui-search'><span class='" + l.icon_base + " " + k.icon_search + "'></span>" + b.Find + "</a>", t = "<a id='" + f + "_reset' class='fm-button " + l.button + " fm-button-icon-left ui-reset'><span class='" + l.icon_base + " " + k.icon_reset + "'></span>" + b.Reset + "</a>", u = "", v = "", w = !1, x = -1, y = !1, z = [];
                        ...
                        w = !1, b.tmplNames && b.tmplNames.length && (w = !0, v = "<tr><td class='ui-search-label'>" + b.tmplLabel + "</td>", v += "<td><select class='ui-template " + k.srSelect + "'>", v += "<option value='default'>Default</option>", a.each(b.tmplNames, function (a, b) {
                        ...
                        }), !0 === b.multipleGroup && (b.multipleSearch = !0), a(d).triggerHandler("jqGridFilterInitialize", [a("#" + f)]), a.isFunction(b.onInitializeSearch) && b.onInitializeSearch.call(d, a("#" + f)), b.gbox = "#gbox_" + f, b.layer ? a.jgrid.createModal(i, m, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0], "#" + a.jgrid.jqID(b.layer), {position: "relative"}) : a.jgrid.createModal(i, m, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0]), (b.searchOnEnter || b.closeOnEscape) && a("#" + a.jgrid.jqID(i.themodal)).keydown(function (c) {
                            var
                                d = a(c.target);
                            ...
                            return d.p.search = !0, a.extend(d.p.postData, j), h = a(d).triggerHandler("jqGridFilterSearch"), void
                                0 === h && (h = !0), h && a.isFunction(b.onSearch) && (h = b.onSearch.call(d, d.p.filters)), !1 !== h && a(d).trigger("reloadGrid", [{page: 1}]), b.closeAfterSearch && a.jgrid.hideModal("#" + a.jgrid.jqID(i.themodal), {
                            ...
                            return d.p.search = !1, d.p.resetsearch = !0, !1 === b.multipleSearch ? c[b.sField] = c[b.sValue] = c[b.sOper] = "" : c[b.sFilter] = "", e[0].resetFilter(), w && a(".ui-template", m).val("default"), a.extend(d.p.postData, c), h = a(d).triggerHandler("jqGridFilterReset"), void
                                0 === h && (h = !0), h && a.isFunction(b.onReset) && (h = b.onReset.call(d)), !1 !== h && a(d).trigger("reloadGrid", [{page: 1}]), b.closeAfterReset && a.jgrid.hideModal("#" + a.jgrid.jqID(i.themodal), {
                                gb: "#gbox_" + a.jgrid.jqID(d.p.id),
                                jqm: b.jqModal,
                                onClose: b.onClose
                            }), !1
...
!function (a) {
    ...
    a.jgrid.inlineEdit = a.jgrid.inlineEdit || {}, a.jgrid.extend({
        editRow: function (b, c, d, e, f, g, h, i, j) {
            var
                k = {}, l = a.makeArray(arguments).slice(1), m = this[0];
            return "object" === a.type(l[0]) ? k = l[0] : (void
                ...
                var
                    c, d, e, f, g, h, i = 0, j = null, l = {}, n = a(this).jqGrid("getStyleUI", m.p.styleUI + ".inlinedit", "inputClass", !0);
                if (m.grid && !1 !== (f = a(m).jqGrid("getInd", b, !0))) {
                    ...
                    e = a(f).attr("editable") || "0", "0" !== e || a(f).hasClass("not-editable-row") || (g = m.p.colModel, a('td[role="gridcell"]', f).each(function (e) {
                        ...
                        if (f) d = a("span:first", this).html(); else
                            try {
                                d = a.unformat.call(m, this, {rowId: b, colModel: g[e]}, e)
                            } catch (b) {
                        ...
                        if (13 === c.keyCode) {
                            ///Impedir salvamento da linha ao clicar Enter
                            return !0;
            ...
            if (void
                ...
                if (m = a(p).attr("editable"), j.url = j.url || k.p.editurl, "1" === m) {
                                ...
                                switch (z.edittype) {
                                    ...
                                    case"custom":
                                        try {
                                            ...
                                            "e1" === b ? a.jgrid.info_dialog(w.errcap, "function 'custom_value' " + x.msg.nodefined, x.bClose, {styleUI: k.p.styleUI}) : a.jgrid.info_dialog(w.errcap, b.message, x.bClose, {styleUI: k.p.styleUI})
                                        }
                                }
                    ...
                    var
                        E, F = k.p.prmNames, G = b;
                    if (E = !1 === k.p.keyName ? F.id : k.p.keyName, r) {
                        if (r[F.oper] = F.editoper, void
                                0 === r[E] || "" === r[E]) r[E] = b; else if (p.id !== k.p.idPrefix + r[E]) {
                            var
                ...
                if (e.grid && !0 === e.p.cellEdit) {
                    if (null !== (d = e.p.savedRow.length >= 1 ? 0 : null)) {
                        ...
                        switch (k.edittype) {
                            ...
                            case"custom":
                                try {
                                    ...
                                    "e1" === b ? a.jgrid.info_dialog(f.errcap, "function 'custom_value' " + g.msg.nodefined, g.bClose, {styleUI: e.p.styleUI}) : "e2" === b ? a.jgrid.info_dialog(f.errcap, "function 'custom_value' " + g.msg.novalue, g.bClose, {styleUI: e.p.styleUI}) : a.jgrid.info_dialog(f.errcap, b.message, g.bClose, {styleUI: e.p.styleUI})
                                }
                        }
                        if (i !== e.p.savedRow[d].v) {
                            ...
                            var
                                t = a.jgrid.checkValues.call(e, h, c), u = !1;
                            if (!0 === t[0]) {
                                var
    ...
    a.jgrid.extend({
        groupingSetup: function () {
                ...
                var
                    g, h, i = e.join("_"), j = d.minusicon, k = d.plusicon, l = a("#" + a.jgrid.jqID(b)), m = l.length ? l[0].nextSibling : null, n = a("#" + a.jgrid.jqID(b) + " span.tree-wrap-" + c.p.direction), o = function (b) {
                        ...
                        return c.length > 0 ? c[0] : void
                                0
                    }, p = !1, q = !1, r = !!c.p.frozenColumns && c.p.id + "_frozen", s = !!r && a("#" + a.jgrid.jqID(b), "#" + a.jgrid.jqID(r)), t = s && s.length ? s[0].nextSibling : null;
                if (n.hasClass(j)) {
                    if (m)for (; m && !(void
            ...
            return b = a.extend({useColSpanStyle: !1, groupHeaders: []}, b || {}), this.each(function () {
                ...
                for (a(q).prepend(x), e = a("<tr>", {role: "row"}).addClass("ui-jqgrid-labels jqg-third-row-header"), c = 0; c < t; c++)if (g = u[c].el, h = a(g), d = s[c], i = {
                        height: "0px",
                        width: u[c].width + "px",
                        display: d.hidden ? "none" : ""
                    }, a("<th>", {role: "gridcell"}).css(i).addClass("ui-first-th-" + q.p.direction).appendTo(y), g.style.width = "", (j = B(d.name, b.groupHeaders)) >= 0) {
            ...
            return void
                ...
                if (k) {
                    for (a(this).off(".setGroupHeaders"), c = a("<tr>", {role: "row"}).addClass("ui-jqgrid-labels"), f = k.headers, d = 0, e = f.length; d < e; d++) {
                    ...
                    a(l).children("tr.ui-jqgrid-labels").remove(), a(l).prepend(c), !0 === b && a(j).jqGrid("setGridParam", {groupHeader: null})
                }
            })
        }
    })
        ...
        setTreeNode: function (b, c) {
            return this.each(function () {
                ...
                if (d.grid && d.p.treeGrid) {
                    ...
                    for (a(d).triggerHandler("jqGridBeforeSetTreeNode", [t, c]), a.isFunction(d.p.beforeSetTreeNode) && d.p.beforeSetTreeNode.call(d, t, c); b < c;) {
                        var
                            u = a.jgrid.stripPref(d.p.idPrefix, d.rows[b].id), v = d.p._index[u];
            ...
            this.each(function () {
                ...
                if (c.grid && c.p.treeGrid) {
                    var
                        d = a(c).jqGrid("getNodeChildren", b), e = c.p.treeReader.expanded_field, f = b[c.p.localReader.id], g = a(c).triggerHandler("jqGridBeforeExpandTreeGridRow", [f, b, d]);
                    void
            ...
            this.each(function () {
                ...
                if (c.grid && c.p.treeGrid) {
                    var
                        d = a(c).jqGrid("getNodeChildren", b), e = c.p.treeReader.expanded_field, f = b[c.p.localReader.id], g = a(c).triggerHandler("jqGridBeforeCollapseTreeGridRow", [f, b, d]);
                    void
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    var
                        c = this, d = this.p.treeReader.expanded_field, e = this.p.treeReader.parent_id_field, f = this.p.treeReader.loaded, g = this.p.treeReader.level_field, h = this.p.treeReader.left_field, i = this.p.treeReader.right_field;
                    if (!b[d]) {
                        var
                            j = a.jgrid.getAccessor(b, this.p.localReader.id), k = a("#" + this.p.idPrefix + a.jgrid.jqID(j), this.grid.bDiv)[0], l = this.p._index[j], m = a(c).triggerHandler("jqGridBeforeExpandTreeGridNode", [j, b]);
                        if (void
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    var
                        c = this.p.treeReader.expanded_field, d = this;
                    if (b[c]) {
                        var
                            e = a.jgrid.getAccessor(b, this.p.localReader.id), f = a("#" + this.p.idPrefix + a.jgrid.jqID(e), this.grid.bDiv)[0], g = a(d).triggerHandler("jqGridBeforeCollapseTreeGridNode", [e, b]);
                        if (void
        ...
        pivotSetup: function (c, d) {
            ...
            return this.each(function () {
                ...
                n(b, c, d, e, f) {
                    var
                        g;
                    if (a.isFunction(b)) g = b.call(y, c, d, e); else
                        switch (b) {
                            case"sum":
                        ...
                        if ("object" != typeof
                            ...
                            if ("level" === d) {
                                if (void
                                    ...
                                    var
                                        h = k[a.level - 1].groupHeaders.length - 1, i = 0 === h ? P : O;
                ...
                var
                    q, r, s, t, u, v, w, x, y = this, z = c.length, A = 0;
                if (l.rowTotals && l.yDimension.length > 0) {
                    var
                        B = l.yDimension[0].dataName;
                    l.yDimension.splice(0, 0, {dataName: B}), l.yDimension[0].converter = function () {
                        return "_r_Totals"
                    }
                }
                ...
                var
                    N = [], O = e.length, P = O;
                u > 0 && (k[u - 1] = {useColSpanStyle: !1, groupHeaders: []}), p(E);
                var
                    Q;
                if (l.colTotals)for (var
                                         R = f.length; R--;)for (s = t; s < e.length; s++)Q = e[s].name, g[Q] ? g[Q] += parseFloat(f[R][Q] || 0) : g[Q] = parseFloat(f[R][Q] || 0);
                if (D > 0)for (s = 0; s < D; s++)e[s].isGroupField && (j.groupingView.groupField.push(e[s].name), j.groupingView.groupSummary.push(l.groupSummary), j.groupingView.groupSummaryPos.push(l.groupSummaryPos)); else
                    j.grouping = !1;
            ...
            return this.each(function () {
                ...
                f(b) {
                    ...
                    var
                        e, f, h, i, j = jQuery(g).jqGrid("pivotSetup", b, c), k = a.assocArraySize(j.summary) > 0, l = a.jgrid.from.call(g, j.rows);
                ...
                if (c) {
                    ...
                    if ((e = a.jgrid.parseFunc(c)) && "object" === a.type(e)) {
                        ...
                        if (m[0].refreshIndex(), e.subGrid) {
                            var
                                o = 1 === e.multiselect ? 1 : 0, p = !0 === e.rownumbers ? 1 : 0;
                        ...
                        if (e.treeGrid)for (var
                            ...
                            var
                                c = b.target || b.srcElement, d = a.jgrid.stripPref(e.idPrefix, a(c, m[0].rows).closest("tr.jqgrow")[0].id), f = m[0].p._index[d];
                        ...
                        }), e.inlineNav && h && (m.jqGrid("setGridParam", {inlineNav: !1}), m.jqGrid("inlineNav", e.pager, h)), e.filterToolbar && i && (m.jqGrid("setGridParam", {filterToolbar: !1}), i.restoreFromFilters = !0, m.jqGrid("filterToolbar", i)), e.frozenColumns && m.jqGrid("setFrozenColumns"), m[0].updatepager(!0, !0), a.isFunction(d.afterSetGrid) && d.afterSetGrid(m), d.clearAfterLoad && (window[d.storageType].removeItem("jqGrid" + j.id), window[d.storageType].removeItem("jqGrid" + j.id + "_data"))
                    } else
            ...
            var
                d = (0 === b.indexOf("#") ? "" : "#") + a.jgrid.jqID(b), e = function (b, c) {
                    ...
                    if (b && "string" == typeof
                            b) {
                        var
                            e = a.jgrid.parseFunc(b), f = e[c.jsonGrid.config], g = e[c.jsonGrid.data];
                        if (g) {
                            var
                                h = f.datatype;
            ...
            return this.each(function () {
                if (this.grid) {
                    ...
                    switch (d.rownumbers && (d.colNames.splice(0, 1), d.colModel.splice(0, 1)), d.multiselect && (d.colNames.splice(0, 1), d.colModel.splice(0, 1)), d.subGrid && (d.colNames.splice(0, 1), d.colModel.splice(0, 1)), d.knv = null, b.exptype) {
                        case"xmlstring":
                            c = "<" + b.root + ">" + a.jgrid.jsonToXML(d, {xmlDecl: ""}) + "</" + b.root + ">";
                            break;
                        case"jsonstring":
        ...
        exportToCsv: function (b) {
            ...
            if (this.each(function () {
                    ...
                    b._regexsep = new
                        ...
                        RegExp(b.quote, "g");
                    var
                        e, f, g, h, i, j = this, k = this.addLocalData(!0), l = k.length, m = j.p.colModel, n = m.length, o = j.p.colNames, p = 0, q = "", r = "", s = "", t = "", u = "", v = [], w = [], x = [], y = [];
                    if (a.each(m, function (c, d) {
                        ...
                        }), b.includeLabels && (u = v.join(b.separator) + b.newLine), b.collen = v.length, j.p.grouping) q += d(k, b); else
                        for (; p < l;) {
                    ...
                    if (b.includeFooter && j.p.footerrow) {
                        ...
                        if (B.length) {
                            ...
                            for (e = 0, p = 0, g = []; e < C.cells.length;) {
                                var
                                    D = C.cells[e], E = a(D).attr("aria-describedby").slice(-3);
            ...
            b = a.extend(!0, {
                ...
                d(b) {
                    ...
                    d(b, d, f, h) {
                        var
                            i, k, l = c(b, d, f), n = l.cnt, p = e(o.header);
                    ...
                    var
                        f = g.p.groupingView, h = [], i = f.groupField.length, j = m.length, k = 0;
                ...
                var
                    e, f, g = this, h = a.jgrid.excelStrings, i = 0, j = a.parseXML(h["xl/worksheets/sheet1.xml"]), k = j.getElementsByTagName("sheetData")[0], l = {
                        _rels: {".rels": a.parseXML(h["_rels/.rels"])},
                        xl: {
                            _rels: {"workbook.xml.rels": a.parseXML(h["xl/_rels/workbook.xml.rels"])},
                    ...
                    }, m = g.p.colModel, n = 0, o = {body: g.addLocalData(!0), header: [], footer: [], width: [], map: []};
                ...
                var
                    p, q, r = a.isFunction(b.replaceStr) ? b.replaceStr : c, s = function (c, d) {
                        p = i + 1, q = a.jgrid.makeNode(j, "row", {attr: {r: p}});
                        for (var
                                 e = 0; e < o.header.length; e++) {
                            var
                                f, h = a.jgrid.excelCellPos(e) + "" + p, l = a.isArray(c) && d ? g.p.colNames[o.map[e]] : c[o.header[e]];
                            if (null == l && (l = ""), d || (l = "" !== l ? a.jgrid.formatCell(l, o.map[e], c, m[o.map[e]], g) : l), o.width[e] = Math.max(o.width[e], Math.min(parseInt(l.length, 10), b.maxlength)), "number" == typeof
                                ...
                                attr: {
                                    t: "n",
                                    r: h
                                }, children: [a.jgrid.makeNode(j, "v", {text: l})]
                            }); else {
                                var
                                    n = l.replace ? r(l) : l;
                                f = a.jgrid.makeNode(j, "c", {
                                    attr: {t: "inlineStr", r: h},
                                    children: {row: a.jgrid.makeNode(j, "is", {children: {row: a.jgrid.makeNode(j, "t", {text: n})}})}
                                })
                            }
                            q.appendChild(f)
                        }
                ...
                if (a("sheets sheet", l.xl["workbook.xml"]).attr("name", b.sheetName), b.includeGroupHeader && g.p.groupHeader && g.p.groupHeader.length) {
                    var
                        t, u, v = g.p.groupHeader, w = [], x = 0;
                    for (u = 0; u < v.length; u++) {
                        var
                            y = v[u].groupHeaders, z = {};
                        for (x++, e = 0, e = 0; e < o.header.length; e++) {
                            ...
                            for (var
                                ...
                                z[t] = y[A].titleText;
                                var
                                    B = a.jgrid.excelCellPos(e) + x, C = a.jgrid.excelCellPos(e + y[A].numberOfColumns - 1) + x;
                                w.push({ref: B + ":" + C})
                            }
                        }
                        s(z, !0)
                    ...
                    a("row c", j).attr("s", "2");
                    var
                        D = a.jgrid.makeNode(j, "mergeCells", {attr: {count: w.length}});
                    for (a("worksheet", j).append(D), n = 0; n < w.length; n++)D.appendChild(a.jgrid.makeNode(j, "mergeCell", {attr: w[n]}))
                }
                if (b.includeLabels && (s(o.header, !0), a("row:last c", j).attr("s", "2")), g.p.grouping) d(o.body); else
                    for (var
                ...
                try {
                    var
                        H = new
                            JSZip, I = {type: "blob", mimeType: b.mimetype};
                    a.jgrid.xmlToZip(H, l), H.generateAsync ? H.generateAsync(I).then(function (c) {
                            a.jgrid.saveAs(c, b.fileName, {type: b.mimetype})
                        }) : a.jgrid.saveAs(H.generate(I), b.fileName, {type: b.mimetype})
                } catch (a) {
                    throw a
                }
            })
...
!function (a) {
    ...
    $.jgrid.extend({
        sortableColumns: function (a) {
            return this.each(function () {
                ...
                var
                    d = this, e = $.jgrid.jqID(d.p.id), f = {
                        ...
                        update: function (a, b) {
                            var
                                c = $(b.item).parent(), e = $(">th", c), f = d.p.colModel, g = {}, h = d.p.id + "_";
                            $.each(f, function (a) {
                                g[this.name] = a
                            });
                            var
                ...
                if (d.p.sortable.options ? $.extend(f, d.p.sortable.options) : $.isFunction(d.p.sortable) && (d.p.sortable = {update: d.p.sortable}), f.start) {
                    var
                        g = f.start;
                ...
                var
                    i = a.sortable(f), j = i.data("sortable") || i.data("uiSortable");
            ...
            d() {
                var
                    a = q(f), b = a.container.closest(".ui-dialog-content");
            ...
            var
                e, f, g, h, i, j, k, l = this, m = {}, n = [], o = l.jqGrid("getGridParam", "colModel"), p = l.jqGrid("getGridParam", "colNames"), q = function (a) {
            ...
            if (!$("#colchooser_" + $.jgrid.jqID(l[0].p.id)).length) {
                ...
                }), g = $.isFunction(a.dlog_opts) ? a.dlog_opts.call(l, a) : a.dlog_opts, c(a.dlog, e, g), h = $.isFunction(a.msel_opts) ? a.msel_opts.call(l, a) : a.msel_opts, c(a.msel, f, h), i = $("#colchooser_" + $.jgrid.jqID(l[0].p.id)), i.css({margin: "auto"}), i.find(">div").css({
                    width: "100%",
                    height: "100%",
                    margin: "auto"
                                        ...
                                        if ($(c.draggable).hasClass("jqgrow")) {
                                            ...
                                            if (!a.dropbyname) {
                                                ...
                                                try {
                                                    for (h
                                                        in
                                                        e)e.hasOwnProperty(h) && (g = k[i].name, "cb" !== g && "rn" !== g && "subgrid" !== g && e.hasOwnProperty(h) && k[i] && (j[g] = e[h]), i++);
                                                    e = j
                                                } catch (a) {
                                                }
                                            }
