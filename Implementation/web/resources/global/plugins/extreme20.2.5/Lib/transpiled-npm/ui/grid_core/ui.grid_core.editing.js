...
var EditingController = _uiGrid_core.default.ViewController.inherit(function () {
  ...
  return {
    ...
    _getLoadedRowIndexByInsertKey: function _getLoadedRowIndexByInsertKey(items, change, key) {
      var dataController = this._dataController;
    ...
    _endSaving: function _endSaving(dataChanges, changes, deferred) {
      ...
      } else if (((_changes$ = changes[0]) === null || _changes$ === void 0 ? void 0 : _changes$.type) !== 'update') {
        this._resetEditIndices();
      }
