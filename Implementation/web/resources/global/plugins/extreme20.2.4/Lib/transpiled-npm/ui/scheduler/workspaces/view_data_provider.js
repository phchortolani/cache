...
var ViewDataProvider = /*#__PURE__*/function () {
  ...
  _createClass(ViewDataProvider, [{
    ...
    value: function findGroupCellStartDate(groupIndex, startDate, endDate, isAllDay) {
      ...
      for (var i = 0; i < dateTable[0].length; ++i) {
        ...
        if (_date.default.sameDate(cell.startDate, startDate)) {
          ...
          if (((_lastCell = lastCell) === null || _lastCell === void 0 ? void 0 : _lastCell.endDate) > startDate) {
    ...
    value: function _getLastGroupRow(groupIndex) {
    ...
    value: function getLasGroupCellIndex(groupIndex) {
      var group = this.groupedDataMap[groupIndex];
