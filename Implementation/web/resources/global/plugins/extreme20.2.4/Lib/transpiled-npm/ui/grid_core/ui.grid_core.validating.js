  ...
  extenders: {
    controllers: {
      editing: {
        ...
        _needInsertItem: function _needInsertItem(_ref10) {
          var key = _ref10.key;
          var result = this.callBase.apply(this, arguments);

          var validationData = this.getController('validating')._getValidationData(key);

          if (result && !(validationData !== null && validationData !== void 0 && validationData.isValid)) {
        ...
        _getInvisibleColumns: function _getInvisibleColumns(changes) {
          var _this5 = this;
      ...
      editorFactory: function () {
        ...
        return {
          ...
          updateCellState: function updateCellState($element, validationResult, hideBorder) {
            ...
            if (validationResult && validationResult.status === VALIDATION_STATUS.invalid || (change === null || change === void 0 ? void 0 : change.type) === 'update' && !this._editingController.isSaving()) {
              if (this._editingController.getEditMode() === EDIT_MODE_CELL) {
