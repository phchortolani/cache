// Modified Date: 2006-08-28 16:41:46
// Modified Language: 3238624631
...
//</script>
	...
	function BuildCOMViewStructure() {
	 ...
	 obj4.innerHTML=4;
	 obj4.title='Field Chooser'  //Field Chooser
	 ...
	 obj2.innerHTML='Favourites';  //Favourites
	 ...
	 obj.id='buttonpanel';
	   cvCreateButton(obj,'new.gif','New',NewView,'newFavourite'); // SR14249
	   cvCreateButton(obj,'open.gif','Open',EditView,'openFavourite'); // SR14249
	   cvCreateButton(obj,'save.gif','Save',SaveView,'saveFavourite'); // SR14249
	   cvCreateButton(obj,'del.gif','Delete',DeleteView,'deleteFavourite'); // SR14249
	   obj2=document.createElement('img');obj.appendChild(obj2);
	   obj2.src=FilePath+'delimiter.gif';
	   obj2=cvCreateButton(obj,'print.gif','Print',PrintSelection,'printResultset'); // SR14249
	   obj2.attachEvent('oncontextmenu',PrintOptions);
	   obj2=cvCreateButton(obj,'copy.gif','Copy',CopySelection,'copyResultset'); // SR14249
	   obj2=cvCreateButton(obj,'selectall.gif','Select',SelectAll,'selectallResultset'); // SR14249
...
obj2=cvCreateButton(obj,'grid.gif','Export to CSV',ExportToCSV,'ExportToCSV');
	 cvCreateButton(obj,'ok.gif','Search',SubmitQuery,'SubmitQuery'); // SR14613
	  ...
	  obj.className='fieldset-ctrl';
	   obj2=document.createElement('legend');obj.appendChild(obj2);
	   obj2.className='legend';
	   obj2.innerHTML='Field Selection';    // Field Selection
