// Modified Date: 2007-02-09 09:50:12
// Modified Language: 3508525231
...
function ChooserSubTypeChanged() {
	CallBack('LoadFields^COMViewChoose',document.getElementById('ChooserField').rows[ChooserCurrentRow()].cells[0].Relation,ChooserSubType.value,"ChooserSubField");
}
// -->
//</script>
...
function BuildCOMViewStructure(pblnInForm,pblnIsSuperUser,pblnUseKeyStroke) {
 ...
 var sWhere='BeforeBegin'; if (pblnInForm==1) { sWhere='BeforeEnd'; }; WWW.insertAdjacentElement(sWhere,objDiv);
 ...
 obj2=document.createElement('legend');obj.appendChild(obj2);
 obj2.className='legend';
 obj2.innerHTML='Seleção de Campo ';
